...
const String EMERGENCY_PHONE = "+919390532606";
//--------------------------------------------------------------
...
#define M1_in2 6  // In2  L298 for Anticlockwise
//--------------------------------------------------------------
...
void setup()
{
  ...
  pinMode(alcohol_sensor, INPUT_PULLUP);
...
distance = duration*0.034/2;// Calculating the distance
 ...
 // analogWrite(M1_Ena, safetyDistance);
 lcd.clear();
 lcd.setCursor(0,0); //col=0 row=0
    
lcd.print("Distance:"+String(safetyDistance));
lcd.print("CM");
safetyDistance = distance;

int mapped_val = map(safetyDistance,286,0,1023,0);
